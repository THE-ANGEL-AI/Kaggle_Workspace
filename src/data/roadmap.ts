...
export const milestones: Milestone[] = [
  ...
  },
  {
    ...
    description: 'Полный аудит ветки site: удаление мёртвого кода, неиспользуемых зависимостей, оптимизация структуры',
    status: 'done',
    icon: '🧹',
    tags: ['Refactor', 'Cleanup', 'Performance'],
    date: '04.07.2026',
    features: ['Removed 4 unused packages', 'Deleted dead components', 'New eslint flat config', 'FadeIn/SectionHeader/AnimatedCounter'],
  },
  {
    phase: 'PHASE 21',
    title: 'Content Refresh',
    description: 'Обновление ленты новостей, roadmap, community-данных и соцдоказательства до актуального состояния',
    status: 'current',
    icon: '📰',
    tags: ['Content', 'News', 'Data'],
    date: '04.07.2026',
    features: ['News entries updated to July 2026', 'Roadmap extended to PHASE 21', 'Community stats refreshed'],
  },
  {
    phase: 'PHASE 22',
    title: 'Vercel Migration & Backend',
    description: 'Перенос исходников в приватный репозиторий, деплой на Vercel, добавление API-шаблона',
    status: 'planned',
    icon: '🚀',
    tags: ['Vercel', 'Backend', 'Deploy'],
    features: ['Private repo for source code', 'Vercel deployment', 'API routes template'],
  },
  {
    phase: 'PHASE 23',
    title: 'New Models & Workflows',
    description: 'Добавление новых генеративных моделей, расширение библиотеки workflow, интеграция сообщества',
    status: 'planned',
    icon: '🧠',
    tags: ['Models', 'Workflows', 'Community'],
    features: ['New model support', 'More ComfyUI workflows', 'Community voting system'],
  },
];
