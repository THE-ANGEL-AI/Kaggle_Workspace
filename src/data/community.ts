...
export const socialPlatforms: SocialPlatform[] = [
  ...
  },
  {
    ...
    stats: [
      ...
      { label: 'Онлайн', value: '15–30' },
      { label: 'Каналов', value: '8' },
    ],
    cta: '🔊 Присоединиться',
  },
  {
    ...
    icon: '📢',
    stats: [
      { label: 'Подписчиков', value: '280+' },
      { label: 'Постов', value: '45+' },
      { label: 'Охват', value: '1.2K / нед' },
    ],
    cta: '📨 Подписаться',
  },
  {
    ...
    icon: '💖',
    stats: [
      { label: 'Подписчиков', value: '15' },
      { label: 'Цель', value: '50' },
      { label: 'Собрано', value: '24%' },
    ],
    cta: '💖 Поддержать',
  },
];
